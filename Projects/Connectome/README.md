...
This code has been updated to run on Python3 and the GoPIGo3. The original code can be found at https://github.com/Connectome/GoPiGo/blob/master/GoPiGoConnectome.py


# Original (now outdated) README:

The original code can be found here: https://github.com/Connectome/GoPiGo
