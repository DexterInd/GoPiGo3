#!/usr/bin/env python
# Modular Robotics Distance Sensor example for the GoPiGo3
#
# This example shows a basic example to read sensor data from the Modular Robotics Distance Sensor.  This sensor is a white PCB.
#
# Connect the Modular Robotics Distance Sensor to an I2C port on the GoPiGo3.
